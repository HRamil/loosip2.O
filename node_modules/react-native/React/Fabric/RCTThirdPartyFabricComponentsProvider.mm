...
Class<RCTComponentViewProtocol> RCTThirdPartyFabricComponentsProvider(const char *name) {
  static std::unordered_map<std::string, Class (*)(void)> sFabricComponentsClassMap = {
    ...
    {"RNSBottomTabs", RNSBottomTabsCls}, // 1

    {"RNSBottomTabsScreen", RNSBottomTabsScreenCls}, // 1

    {"RNSFullWindowOverlay", RNSFullWindowOverlayCls}, // 1

    {"RNSScreenStackHost", RNSScreenStackHostCls}, // 1

    {"RNSSplitViewHost", RNSSplitViewHostCls}, // 1

    {"RNSSplitViewScreen", RNSSplitViewScreenCls}, // 1

    {"RNSStackScreen", RNSStackScreenCls}, // 1
